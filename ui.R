  ...
  navbarPage(
    ...
    tabPanel(
      ...
      mainPanel(
        ...
        p("Abundant species with many close relatives have the", strong("lowest EDGE scores"),",while critically endangered species that have few (or no) close relatives have the",strong("highest EDGE scores.")), 
        ...
        p("You can use the Explore tab to explore the global list of 9,993 bird species. If you don’t have an ebird checklist, you can still determine your highest EDGE sightings using the Explore tab"),
        p("You can also calculate the Phylogenetic Distance",strong("(PD)"), "which is the sum of all the branches (in Million Years) of the tree created by your checklist. Red and blue branches in the diagram, if your checklist only had the Hoatzin and two gulls.")
  )),    
        br(),br(),
